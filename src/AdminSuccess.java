...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		JButton btnNewButton = new JButton("Add Restaurant");
		btnNewButton.setFont(new Font("Tahoma", Font.PLAIN, 15));
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				RestaurantForm.main(new String[]{});
				frame.dispose();
			}
		});
		
		JButton btnViewLibrarian = new JButton("View Restaurant");
...
//		JButton btnDeleteLibrarian = new JButton("Delete Restaurant");
//		btnDeleteLibrarian.addActionListener(new ActionListener() {
//			public void actionPerformed(ActionEvent e) {
//				DeleteRestaurant.main(new String[]{});
//				frame.dispose();
//			}
//		});
